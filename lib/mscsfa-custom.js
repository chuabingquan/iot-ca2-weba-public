...
// Create constructor
function Mscsfa(mscsfaSubscriptionKey, regionCode) {
    // Constructor properties
    this.subscriptionKey = mscsfaSubscriptionKey;
    this.apiUrl = matchRegion(regionCode);
}

// Detect function API wrapper
Mscsfa.prototype.detect = function (image) {
...
Mscsfa.prototype.createPerson = function (personGroupId, userData) {
    return new Promise((resolve, reject) => {
        // Declarations
        var error;
...
Mscsfa.prototype.deletePerson = function (personGroupId, personId) {
    return new Promise((resolve, reject) => {
        // Construct AJAX
        request({
                method: 'DELETE',
...
Mscsfa.prototype.addFace = function (personGroupId, personId, faceRectangle, image) {
    return new Promise((resolve, reject) => {
        // Declarations 
        var error;
        // Construct query parameters
...
Mscsfa.prototype.createPersonGroupIfNotExist = function (personGroupId, personGroupInformation) {
    return new Promise((resolve, reject) => {
        // Construct AJAX
        request({
                method: 'PUT',
...
Mscsfa.prototype.deleteFace = function (personGroupId, personId, faceId) {
    return new Promise((resolve, reject) => {
        // Construct AJAX
        request({
                method: 'DELETE',
...
Mscsfa.prototype.trainPersonGroup = function (personGroupId) {
    return new Promise((resolve, reject) => {
        // Construct AJAX
        request({
                method: 'POST',
...
Mscsfa.prototype.identify = function (personGroupId, faceIds, maxNumOfCandidatesReturned, minimumConfidence) {
    return new Promise((resolve, reject) => {
        // Construct AJAX
        request({
                method: 'POST',
...
// Create full person
Mscsfa.prototype.createFullPerson = function (image, userInformation, personGroupId) {
    return new Promise((resolve, reject) => {
        // Declarations
...
Mscsfa.prototype.updatePersonWithSingle = function (image, userInformation, personGroupId, personId, oldPersistedFaceId) {
    return new Promise((resolve, reject) => {
        // Declarations
        var detectFaceRectangle;
        var respObject = new Object();
...
Mscsfa.prototype.recognize = function (image, personGroupId, maxNumOfCandidatesReturned, minimumConfidence) {
    return new Promise((resolve, reject) => {
        // Detect person in image
        this.detect(image)
            .then((faceInfo) => {
